<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	...
	<div class="navbar-header">
		...
		<a class="navbar-brand" href="/blog/">SB Admin</a>
	</div>
	<!-- Top Menu Items -->
	...
	<div class="collapse navbar-collapse navbar-ex1-collapse">
		<ul class="nav navbar-nav side-nav">
				...
				<ul id="post_dropdown" class="collapse">
					<?php 
			 		...
			 		echo"<li>
						...
						?>
					<li>
						<a href="./posts.php?source=my_post">My Posts</a>
					</li>
					<li>
			...
			if ($_SESSION['user_role'] == 'admin') {
			 ...
			 echo	"<li>
					<a href='javascript:;' data-toggle='collapse' data-target='#demo'><i class='fa fa-fw fa-wrench'></i> Users <i class='fa fa-fw fa-caret-down'></i></a>
